...
class DbMysql {
    ...
    public function __construct() {
        ...
        $config['DB_HOST'] = LOG_SYSTEM_DBHOST;
        $config['DB_USER'] = LOG_SYSTEM_DBUSER;
        $config['DB_PASS'] = LOG_SYSTEM_DBPWD;
        $config['DB_PORT'] = LOG_SYSTEM_DBPORT;
        $config['DB_PCONNECT'] = 0;
        $config['DB_CHARSET'] = "utf8";
        $config['DB_NAME'] = LOG_SYSTEM_DBNAME;
